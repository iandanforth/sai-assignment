...
class CloudpickleWrapper(object):
    def __init__(self, var):
        ...
        :param var: (Any) the variable you wish to wrap for pickling with
            cloudpickle
        """
        self.var = var
...
def _worker(remote, parent_remote, seed, init_fn, shared_Q):
    """
...
class ProcessRunner(object):
    ...
    """
    def __init__(self, seeds, init_fns, shared_Q):
        self.waiting = False
        self.closed = False
